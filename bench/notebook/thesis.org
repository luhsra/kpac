...
#+begin_src python :results none
  ...
  for i, host in enumerate(hosts):
      ...
      ax.axhline(exps[host]['nop']['all']['oh'].median(), linestyle='--', linewidth=1, color="#D32F2F", alpha=0.6)
      ax.axhline(exps[host]['xxhash']['all']['oh'].median(), linestyle='--', linewidth=1, color="#303F9F", alpha=0.6)
      ax.axhline(exps[host]['qarma']['all']['oh'].median(), linestyle='--', linewidth=1, color="#00796B", alpha=0.6)
